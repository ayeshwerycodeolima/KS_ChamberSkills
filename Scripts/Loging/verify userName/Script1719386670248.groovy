...
WebUI.setText(findTestObject('Object Repository/Page_CHAMBER SKILLS/input_Email_email'), 'qagmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_CHAMBER SKILLS/input_Password_password'), 'HADZinu5K4A=')
